---
title: D2 quick start
description: Render D2 diagrams progressively in markstream-vue, with previews that refine as tokens stream and source preserved when rendering fails.
keywords:
  - d2 diagrams
...
No extra CSS import is required. Keep `markstream-vue/index.css` after your reset and use `@import '...' layer(components)` if you use Tailwind/UnoCSS.
