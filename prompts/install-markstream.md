...
只安装满足这些能力所需的最小 peer 依赖：[填写 stream-diffs（增强代码块）/ Mermaid / D2 / KaTeX]。
...
Install only the smallest peer-dependency set needed for these features: [fill in stream-diffs (enhanced code blocks) / Mermaid / D2 / KaTeX].
